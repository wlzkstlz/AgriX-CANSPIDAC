...
{
	if(bit)
		HAL_GPIO_WritePin(GPIOD, DAC8562SYNC_Pin, GPIO_PIN_SET);
	else
		HAL_GPIO_WritePin(GPIOD, DAC8562SYNC_Pin, GPIO_PIN_RESET);
}

void setDin(uint8_t bit)
{
	if(bit)
		 HAL_GPIO_WritePin(GPIOD, DAC8562DIN_Pin, GPIO_PIN_SET);
	else
		 HAL_GPIO_WritePin(GPIOD, DAC8562DIN_Pin, GPIO_PIN_RESET);
}
...
void setCLK(uint8_t bit)
{
	...
	if(bit)
		 HAL_GPIO_WritePin(GPIOD, DAC8562CLK_Pin, GPIO_PIN_SET);
	else
		 HAL_GPIO_WritePin(GPIOD, DAC8562CLK_Pin, GPIO_PIN_RESET);
}
